                ...
                <h2>'.mo_("LICENSING PLANS").'
                    ...
                    <input type="button"  name="Supported_payment_methods" id="pmt_btn"
                        ...
                        <input type="button" name="ok_btn" id="ok_btn" class="button button-primary button-large"
                                value="'.mo_("OK, Got It").'" onclick="window.location.href=\''.esc_url($formSettings).'\'" />
                    </span>
                <h2>
                <hr>';
echo '
    ...
    <table class="mo_price-table">
        ...
        <tr>
            ...
            <tr class="mo_price-table-head">
                ...
                <td>
                    TWILIO + MSG91 GATEWAY WITH ADDONS
                    <span class="mo_pricing_question tooltip">
                                        <i class="dashicons dashicons-warning" data-toggle="onprem"></i>
                                        <span class="tooltiptext">
                                            <span class="header">
        ...
        echo'                                <div class="mo_pricing_button"><input type="button"  '.esc_attr($disabled).' class="button button-primary button-large mo_dollar_price"
        ...
        echo'                </td>
                                ...
                                if(strcmp($plan,MoConstants::AACODE)==0 || strcmp($plan,MoConstants::AACODE2)==0
                                    ...
                                    echo '<div class="mo_pricing_button"><input type="button" ' . esc_attr($disabled ). '
                ...
                echo '      </td>
                                <td class="mo_price"><div class="mo_charges">$49</div><br><br><br><br>
                                <div class="mo_plan_description">
                ...
                echo '
                                ...
                                <td class="mo_price"><div class="mo_charges">$99</div><br><br><br><br>
                                <div class="mo_plan_description">
                                miniOrange + AWS SNS
                                <br> Twilio + Custom SMS Gateway
                                <br>Alphanumeric OTP
                                <br>Selected countries OTP
                                <br>Premium Support<br><span style="font-size: 15px; color:red;"> <b> *100 SMS and 200 Email Free.</b></span></div><br><br>';
